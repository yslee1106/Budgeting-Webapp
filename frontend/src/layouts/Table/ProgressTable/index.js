...
function ProgressTable({ title, data, handleMoreOptionsClick, handleSortChange, handleAdd, sortBy }) {
    return (
        <Box
            sx={{
                width: "100%",
            ...
            <TableHeader title={title} handleSortChange={handleSortChange} sortBy={sortBy} handleAdd={handleAdd} />
