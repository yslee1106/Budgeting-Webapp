        ...
        self.budget_management_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    "Confirm the account and transaction details with the user before executing any sensitive tools and inform them of the resulting balance changes of the accounts if any. "
